...
public class visual_controller extends PApplet {
...
class Button{
  ...
  public void drawTriangle(char c){
    fill(155,162,178);
    if(c == 'u'){
      triangle(m_x+0.1f*m_xlen, m_y+0.85f*m_xlen, m_x+0.9f*m_xlen, m_y+0.85f*m_xlen, m_x+0.5f*m_xlen, m_y+0.15f*m_xlen);
    }else if(c == 'd'){
      triangle(m_x+0.1f*m_xlen, m_y+0.15f*m_xlen, m_x+0.9f*m_xlen, m_y+0.15f*m_xlen, m_x+0.5f*m_xlen, m_y+0.85f*m_xlen);
    }
...
public void updateSerialHis(String s){
  for(int i = 0;i < 25;i++){
...
public void serialEvent(Serial wataamech) { // serialEvent(serial wataamech)
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "visual_controller" };
    if (passedArgs != null) {
